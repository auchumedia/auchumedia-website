      ...
      <section id="services" style={{ background: '#080808' }}>
        ...
        <div className="services-wrapper" style={{ padding: '0 60px 300px' }}>
          {[
            ...
            { num: '03', bg: 'linear-gradient(135deg, #1a0a0a, #2a1a1a)', video: null, image: null, titreFr: 'VIDÉO COMMERCIALE', titreEn: 'COMMERCIAL VIDEO', descFr: "Vidéos produites pour tes commanditaires et partenariats. Du contenu premium qui reflète ton branding et maximise la valeur de chaque collaboration.", descEn: "Videos produced for your sponsors and partnerships. Premium content that reflects your brand and maximizes the value of every collaboration." },
