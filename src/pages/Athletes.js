      ...
      <section id="services" style={{ background: '#080808' }}>
        ...
        <div className="services-wrapper" style={{ padding: '0 60px 300px' }}>
          {[
            ...
            { num: '04', bg: '#0a0a0a', video: null, image: 'https://res.cloudinary.com/dr0kwuqqa/image/upload/v1788132498/Capture_d_%C3%A9cran_le_2026-08-30_%C3%A0_19.27.24_p9dffe.png', titreFr: 'VIDÉO COMMERCIALE', titreEn: 'COMMERCIAL VIDEO', descFr: "Vidéos produites pour tes commanditaires et partenariats. Du contenu premium qui reflète ton branding et maximise la valeur de chaque collaboration.", descEn: "Videos produced for your sponsors and partnerships. Premium content that reflects your brand and maximizes the value of every collaboration." },
          ].map((item, i) => (
