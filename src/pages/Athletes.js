  ...
  return (
    <div style={{ background: '#080808', minHeight: '100vh' }}>
      ...
      <section id="services" style={{ background: '#080808' }}>
        ...
        <div className="services-wrapper" style={{ padding: '0 60px 100px' }}>
          {[
            ...
            <div key={i} className="sticky-service-card" style={{ position: 'sticky', top: `${80 + i * 30}px`, zIndex: i + 1, height: '500px', maxWidth: '900px', margin: '0 auto', borderRadius: '20px', overflow: 'hidden' }}>
              {item.video && <video autoPlay muted loop playsInline crossOrigin="anonymous" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover' }}><source src={item.video} type="video/mp4" />{item.videoMov && <source src={item.videoMov} type="video/quicktime" />}</video>}
